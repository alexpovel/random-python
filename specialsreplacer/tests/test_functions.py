...
import pytest
from specialsreplacer import (ENCODING, cf_contains, combinations_any_length,
...
class TestMainDE:
    ...
    def known_words(self):
        ...
        # specialreplacer worked. That way, `open_text` is also guaranteed to work.
        # Messing around here using relative Paths on the other hand is error-prone.
        with open_text(
            "specialsreplacer.dicts.containing_specials_only",
            "de.dic",
            encoding=ENCODING,
        ) as f:
    ...
    def specials_to_alt_spellings(self):
        ...
        """
        with open_text(
            "specialsreplacer", "language_specials.json", encoding=ENCODING
        ) as f:
